...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='mediapipe/tasks/cc/vision/face_geometry/proto/mesh_3d.proto',
...
_MESH3D_VERTEXTYPE = _descriptor.EnumDescriptor(
  name='VertexType',
  full_name='mediapipe.tasks.vision.face_geometry.proto.Mesh3d.VertexType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_MESH3D_PRIMITIVETYPE = _descriptor.EnumDescriptor(
  name='PrimitiveType',
  full_name='mediapipe.tasks.vision.face_geometry.proto.Mesh3d.PrimitiveType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MESH3D = _descriptor.Descriptor(
  name='Mesh3d',
  full_name='mediapipe.tasks.vision.face_geometry.proto.Mesh3d',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='vertex_type', full_name='mediapipe.tasks.vision.face_geometry.proto.Mesh3d.vertex_type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='primitive_type', full_name='mediapipe.tasks.vision.face_geometry.proto.Mesh3d.primitive_type', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vertex_buffer', full_name='mediapipe.tasks.vision.face_geometry.proto.Mesh3d.vertex_buffer', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='index_buffer', full_name='mediapipe.tasks.vision.face_geometry.proto.Mesh3d.index_buffer', index=3,
